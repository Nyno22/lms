            ...
            <div class="header-wrap">
                ...
                <div class="header-menu">
                    <ul>
                                    ...
                                    <div>
                                        ...
                                        <div class="row row-lg-5 row-xl-5">
                                            ...
                                            <div class="col el-flag">
                                                <div class="inner">
                                                    <a href="page-departements.html">
                                                        <img src="{{ asset('userassets/images/flags/vietnam.svg') }}" alt="alt">
                                            ...
                                            <div class="col el-flag">
                                                <div class="inner">
                                                    <a href="page-departements.html">
                                                        <img src="{{ asset('userassets/images/flags/poland.svg') }}" alt="alt">
                                            ...
                                            <div class="col el-flag">
                                                <div class="inner">
                                                    <a href="page-departements.html">
                                                        <img src="{{ asset('userassets/images/flags/israel.svg') }}" alt="alt">
                                            ...
                                            <div class="col el-flag">
                                                <div class="inner">
                                                    <a href="page-departements.html">
                                                        <img src="{{ asset('userassets/images/flags/bangladesh.svg') }}" alt="alt">
                        ...
                        <li>
                            <a href="javascript:void(0)" onclick="tsess()">
                                <span class="text">Teacher?</span>
                                <span class="icon fa fa-angle-left"></span>
                            </a>
                        </li>
                ...
                <div class="header-logo">
                    <a href="home.html" class="primary-logo">
                        <span class="text-1">Learnguage</span>
                        <span class="text-2"></span>
                    </a>
                </div>
                <div class="header-links">
                    <a href="{{route ('login')}}" class="button button-md button-light button-line-primary">
